...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-core/internal/datasource_group_roles"
...
const read_ds_groupRoles = "/core/admin/groups/{uuid}/roles"

var (
	_ datasource.DataSource              = (*groupRolesDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*groupRolesDataSource)(nil)
)
...
func (d *groupRolesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_group_roles.GroupRolesDataSourceSchema(ctx)
}

func (d *groupRolesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_group_roles.GroupRolesModel
	...
	err = d.client.GetByQuery(ctx, read_ds_groupRoles, map[string]string{
...
func (r *groupRolesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
