...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-core/internal/datasource_workflow"
...
const read_ds_workflow = "/core/workflow/v1/workflow/{workflowId}"
...
func (d *workflowDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_workflow, map[string]string{
...
func (r *workflowDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
