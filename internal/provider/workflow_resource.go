...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-core/internal/resource_workflow"
	"github.com/nokia/eda/apps/terraform-provider-core/internal/tfutils"
)

const (
	create_rs_workflow = "/core/workflow/v1"
	read_rs_workflow   = "/core/workflow/v1/workflow/{workflowId}"
	update_rs_workflow = ""
	delete_rs_workflow = ""
)
...
func (r *workflowResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_workflow, nil, reqBody, &result)
...
func (r *workflowResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	resp.Diagnostics.Append(resp.State.SetAttribute(ctx, path.Root("workflowId"), parts[0])...)
}
