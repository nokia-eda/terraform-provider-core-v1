...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-core/internal/datasource_alarm"
...
var (
	...
	_ datasource.DataSourceWithConfigure = (*alarmDataSource)(nil)
)
...
func (r *alarmDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
