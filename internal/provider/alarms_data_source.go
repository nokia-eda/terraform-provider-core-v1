...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-core/internal/datasource_alarms"
...
const read_ds_alarms = "/core/alarm/v2/namespaces/{nsName}/alarms"

var (
	_ datasource.DataSource              = (*alarmsDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*alarmsDataSource)(nil)
)
...
func (d *alarmsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	t0 := time.Now()
	result := []any{}
	err = d.client.GetByQuery(ctx, read_ds_alarms, map[string]string{
...
func (r *alarmsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
