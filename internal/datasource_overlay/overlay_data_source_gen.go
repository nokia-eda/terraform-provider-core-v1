...
func OverlayDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"overlay_name": schema.StringAttribute{
				...
				MarkdownDescription: "The name of the overlay to retrieve",
			},
			"topology_name": schema.StringAttribute{
				Required:            true,
				Description:         "The name of the topology to that owns this overlay",
				MarkdownDescription: "The name of the topology to that owns this overlay",
			},
			"ui_description": schema.StringAttribute{
				Computed: true,
			},
...
type OverlayModel struct {
	EndpointAttrQueries     types.List   `tfsdk:"endpoint_attr_queries"`
	EndpointState           types.List   `tfsdk:"endpoint_state"`
	EndpointStateHeading    types.String `tfsdk:"endpoint_state_heading"`
	EndpointStateHeadingKey types.String `tfsdk:"endpoint_state_heading_key"`
	Group                   types.String `tfsdk:"group"`
	LinkAttrQueries         types.List   `tfsdk:"link_attr_queries"`
	LinkState               types.List   `tfsdk:"link_state"`
	LinkStateHeading        types.String `tfsdk:"link_state_heading"`
	LinkStateHeadingKey     types.String `tfsdk:"link_state_heading_key"`
	Name                    types.String `tfsdk:"name"`
	NodeAttrQueries         types.List   `tfsdk:"node_attr_queries"`
	NodeBadge               types.List   `tfsdk:"node_badge"`
	NodeState               types.List   `tfsdk:"node_state"`
	NodeStateHeading        types.String `tfsdk:"node_state_heading"`
	NodeStateHeadingKey     types.String `tfsdk:"node_state_heading_key"`
	OverlayName             types.String `tfsdk:"overlay_name"`
	TopologyName            types.String `tfsdk:"topology_name"`
	UiDescription           types.String `tfsdk:"ui_description"`
	UiDescriptionKey        types.String `tfsdk:"ui_description_key"`
	UiName                  types.String `tfsdk:"ui_name"`
	UiNameKey               types.String `tfsdk:"ui_name_key"`
