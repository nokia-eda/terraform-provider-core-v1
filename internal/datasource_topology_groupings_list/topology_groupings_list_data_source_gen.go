...
package datasource_topology_groupings_list
...
func TopologyGroupingsListDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"api_version": schema.StringAttribute{
				Computed:            true,
				Description:         "The group/version for the topology grouping data.",
				MarkdownDescription: "The group/version for the topology grouping data.",
			},
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"kind": schema.StringAttribute{
							...
							MarkdownDescription: "The kind for the topology grouping data.",
						},
						"metadata": schema.SingleNestedAttribute{
							...
							MarkdownDescription: "The metadata kind for the topology grouping data.",
						},
			...
			"topology_name": schema.StringAttribute{
				...
				MarkdownDescription: "the name of the topology whose grouping(s) should be retrieved",
			},
		},
	}
}

type TopologyGroupingsListModel struct {
...
func (t ItemsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	specVal, ok := specAttribute.(basetypes.MapValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`spec expected to be basetypes.MapValue, was: %T`, specAttribute))
	}
	...
	statusVal, ok := statusAttribute.(basetypes.MapValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`status expected to be basetypes.MapValue, was: %T`, statusAttribute))
	}
...
type ItemsValue struct {
	...
	Spec       basetypes.MapValue    `tfsdk:"spec"`
	Status     basetypes.MapValue    `tfsdk:"status"`
...
func (v ItemsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["spec"] = basetypes.MapType{
		ElemType: SpecValue{}.Type(ctx),
	}.TerraformType(ctx)
	attrTypes["status"] = basetypes.MapType{
...
func (v ItemsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"spec": basetypes.MapType{
			ElemType: SpecValue{}.Type(ctx),
		},
		"status": basetypes.MapType{
			ElemType: StatusValue{}.Type(ctx),
		},
	}
