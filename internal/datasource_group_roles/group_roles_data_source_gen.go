...
package datasource_group_roles
...
func GroupRolesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"group_roles": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: GroupRolesType{
						ObjectType: types.ObjectType{
							AttrTypes: GroupRolesValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
			...
			"uuid": schema.StringAttribute{
				...
				MarkdownDescription: "The UUID of the EDA user group whose roles should be retrieved.",
			},
		},
	}
}
...
type GroupRolesModel struct {
	GroupRoles types.Set    `tfsdk:"group_roles"`
	Uuid       types.String `tfsdk:"uuid"`
}

var _ basetypes.ObjectTypable = GroupRolesType{}

type GroupRolesType struct {
	basetypes.ObjectType
}

func (t GroupRolesType) Equal(o attr.Type) bool {
	other, ok := o.(GroupRolesType)
...
func (t GroupRolesType) String() string {
	return "GroupRolesType"
}

func (t GroupRolesType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
...
func NewGroupRolesValueNull() GroupRolesValue {
	return GroupRolesValue{
		state: attr.ValueStateNull,
	}
}

func NewGroupRolesValueUnknown() GroupRolesValue {
	return GroupRolesValue{
		state: attr.ValueStateUnknown,
	}
}

func NewGroupRolesValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (GroupRolesValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing GroupRolesValue Attribute Value",
				"While creating a GroupRolesValue value, a missing attribute value was detected. "+
					"A GroupRolesValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("GroupRolesValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid GroupRolesValue Attribute Type",
				"While creating a GroupRolesValue value, an invalid attribute value was detected. "+
					"A GroupRolesValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("GroupRolesValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("GroupRolesValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra GroupRolesValue Attribute Value",
				"While creating a GroupRolesValue value, an extra attribute value was detected. "+
					"A GroupRolesValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra GroupRolesValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewGroupRolesValueUnknown(), diags
	}
...
func NewGroupRolesValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) GroupRolesValue {
	object, diags := NewGroupRolesValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewGroupRolesValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t GroupRolesType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewGroupRolesValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewGroupRolesValueUnknown(), nil
	}
	...
	return NewGroupRolesValueMust(GroupRolesValue{}.AttributeTypes(ctx), attributes), nil
}

func (t GroupRolesType) ValueType(ctx context.Context) attr.Value {
	return GroupRolesValue{}
}

var _ basetypes.ObjectValuable = GroupRolesValue{}

type GroupRolesValue struct {
...
func (v GroupRolesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v GroupRolesValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v GroupRolesValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v GroupRolesValue) String() string {
	return "GroupRolesValue"
}

func (v GroupRolesValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v GroupRolesValue) Equal(o attr.Value) bool {
	other, ok := o.(GroupRolesValue)
...
func (v GroupRolesValue) Type(ctx context.Context) attr.Type {
	return GroupRolesType{
		basetypes.ObjectType{
...
func (v GroupRolesValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
