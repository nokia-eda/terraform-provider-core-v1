...
package datasource_auth_user_groups
...
func AuthUserGroupsDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"auth_user_groups": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: AuthUserGroupsType{
						ObjectType: types.ObjectType{
							AttrTypes: AuthUserGroupsValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
var _ basetypes.ObjectTypable = AuthUserGroupsType{}

type AuthUserGroupsType struct {
	basetypes.ObjectType
}

func (t AuthUserGroupsType) Equal(o attr.Type) bool {
	other, ok := o.(AuthUserGroupsType)
...
func (t AuthUserGroupsType) String() string {
	return "AuthUserGroupsType"
}

func (t AuthUserGroupsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	if !ok {
		diags.AddError(
			"Attribute Missing",
			`full_roles is missing from object`)

		return nil, diags
	}

	fullRolesVal, ok := fullRolesAttribute.(basetypes.ListValue)
	...
	if !ok {
		diags.AddError(
			"Attribute Missing",
			`fullusers is missing from object`)
	...
	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`fullusers expected to be basetypes.ListValue, was: %T`, fullusersAttribute))
	}

	isFederatedAttribute, ok := attributes["is_federated"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`is_federated is missing from object`)

		return nil, diags
	}

	isFederatedVal, ok := isFederatedAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`is_federated expected to be basetypes.BoolValue, was: %T`, isFederatedAttribute))
	}
...
func NewAuthUserGroupsValueNull() AuthUserGroupsValue {
	return AuthUserGroupsValue{
		state: attr.ValueStateNull,
	}
}

func NewAuthUserGroupsValueUnknown() AuthUserGroupsValue {
	return AuthUserGroupsValue{
		state: attr.ValueStateUnknown,
	}
}

func NewAuthUserGroupsValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (AuthUserGroupsValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing AuthUserGroupsValue Attribute Value",
				"While creating a AuthUserGroupsValue value, a missing attribute value was detected. "+
					"A AuthUserGroupsValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("AuthUserGroupsValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid AuthUserGroupsValue Attribute Type",
				"While creating a AuthUserGroupsValue value, an invalid attribute value was detected. "+
					"A AuthUserGroupsValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("AuthUserGroupsValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("AuthUserGroupsValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra AuthUserGroupsValue Attribute Value",
				"While creating a AuthUserGroupsValue value, an extra attribute value was detected. "+
					"A AuthUserGroupsValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra AuthUserGroupsValue Attribute Name: %s", name),
			)
		}
	}
...
func NewAuthUserGroupsValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) AuthUserGroupsValue {
	object, diags := NewAuthUserGroupsValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewAuthUserGroupsValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t AuthUserGroupsType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewAuthUserGroupsValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewAuthUserGroupsValueUnknown(), nil
	}
	...
	return NewAuthUserGroupsValueMust(AuthUserGroupsValue{}.AttributeTypes(ctx), attributes), nil
}

func (t AuthUserGroupsType) ValueType(ctx context.Context) attr.Value {
	return AuthUserGroupsValue{}
}
...
func (v AuthUserGroupsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["is_federated"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.IsFederated.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["is_federated"] = val
...
func (v AuthUserGroupsValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v AuthUserGroupsValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v AuthUserGroupsValue) String() string {
	return "AuthUserGroupsValue"
}

func (v AuthUserGroupsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics

	fullRoles := types.ListValueMust(
		FullRolesType{
			basetypes.ObjectType{
				AttrTypes: FullRolesValue{}.AttributeTypes(ctx),
			},
		},
		v.FullRoles.Elements(),
	)

	if v.FullRoles.IsNull() {
		fullRoles = types.ListNull(
			FullRolesType{
				basetypes.ObjectType{
					AttrTypes: FullRolesValue{}.AttributeTypes(ctx),
				},
	...
	if v.FullRoles.IsUnknown() {
		fullRoles = types.ListUnknown(
			FullRolesType{
				basetypes.ObjectType{
					AttrTypes: FullRolesValue{}.AttributeTypes(ctx),
				},
	...
	case v.Roles.IsUnknown():
		rolesVal = types.ListUnknown(types.StringType)
	case v.Roles.IsNull():
		rolesVal = types.ListNull(types.StringType)
	default:
...
func (v AuthUserGroupsValue) Equal(o attr.Value) bool {
	other, ok := o.(AuthUserGroupsValue)
	...
	if !v.IsFederated.Equal(other.IsFederated) {
		return false
	}
...
func (v AuthUserGroupsValue) Type(ctx context.Context) attr.Type {
	return AuthUserGroupsType{
		basetypes.ObjectType{
