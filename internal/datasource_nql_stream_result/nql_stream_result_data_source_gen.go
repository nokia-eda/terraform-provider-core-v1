...
package datasource_nql_stream_result
...
func NqlStreamResultDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"query": schema.StringAttribute{
				...
				MarkdownDescription: "the information being queried, in the natural query language",
			},
		},
	}
}

type NqlStreamResultModel struct {
