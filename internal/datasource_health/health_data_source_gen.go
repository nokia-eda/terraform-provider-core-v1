...
func HealthDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"mode": schema.StringAttribute{
				Computed:            true,
				Description:         "Indication of the activity of this cluster.",
				MarkdownDescription: "Indication of the activity of this cluster.",
			},
			"services": schema.MapNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"error": schema.StringAttribute{
							...
							MarkdownDescription: "Detailed status if the service is not up.",
						},
						"status": schema.StringAttribute{
							Computed:            true,
							Description:         "Health status of the given service.  UP or DOWN.",
							MarkdownDescription: "Health status of the given service.  UP or DOWN.",
						},
					},
				...
				MarkdownDescription: "Detailed health of the services comprising the EDA cluster.  Keyed by the name of the service.",
			},
			"status": schema.StringAttribute{
				Computed:            true,
				Description:         "Overall health status of the EDA cluster.",
				MarkdownDescription: "Overall health status of the EDA cluster.",
			},
			"timestamp": schema.StringAttribute{
				Computed:            true,
				Description:         "Time that the health report was generated.",
				MarkdownDescription: "Time that the health report was generated.",
			},
		},
	}
}
