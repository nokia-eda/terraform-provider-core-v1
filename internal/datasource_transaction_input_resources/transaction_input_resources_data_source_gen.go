...
package datasource_transaction_input_resources
...
func TransactionInputResourcesDataSourceSchema(ctx context.Context) schema.Schema {
...
type TransactionInputResourcesModel struct {
