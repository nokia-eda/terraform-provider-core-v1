...
package datasource_transaction_result_intents_run
...
func TransactionResultIntentsRunDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"has_more": schema.BoolAttribute{
				Computed:            true,
				Description:         "When paginating: true if more intents exist; use nextCursor to fetch the next page.",
				MarkdownDescription: "When paginating: true if more intents exist; use nextCursor to fetch the next page.",
			},
			...
			"search": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "Case-insensitive substring match on intent name.",
				MarkdownDescription: "Case-insensitive substring match on intent name.",
			},
...
type TransactionResultIntentsRunModel struct {
