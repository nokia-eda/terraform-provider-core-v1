...
package datasource_transaction_summary_results
...
func TransactionSummaryResultsDataSourceSchema(ctx context.Context) schema.Schema {
...
type TransactionSummaryResultsModel struct {
