...
package datasource_cluster_auth_roles
...
func ClusterAuthRolesDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"cluster_auth_roles": schema.SetNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					...
					CustomType: ClusterAuthRolesType{
						ObjectType: types.ObjectType{
							AttrTypes: ClusterAuthRolesValue{}.AttributeTypes(ctx),
						},
					},
				},
				Computed: true,
...
type ClusterAuthRolesModel struct {
	ClusterAuthRoles types.Set `tfsdk:"cluster_auth_roles"`
}

var _ basetypes.ObjectTypable = ClusterAuthRolesType{}

type ClusterAuthRolesType struct {
	basetypes.ObjectType
}

func (t ClusterAuthRolesType) Equal(o attr.Type) bool {
	other, ok := o.(ClusterAuthRolesType)
...
func (t ClusterAuthRolesType) String() string {
	return "ClusterAuthRolesType"
}

func (t ClusterAuthRolesType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
...
func NewClusterAuthRolesValueNull() ClusterAuthRolesValue {
	return ClusterAuthRolesValue{
		state: attr.ValueStateNull,
	}
}

func NewClusterAuthRolesValueUnknown() ClusterAuthRolesValue {
	return ClusterAuthRolesValue{
		state: attr.ValueStateUnknown,
	}
}

func NewClusterAuthRolesValue(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) (ClusterAuthRolesValue, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	for name, attributeType := range attributeTypes {
		...
		if !ok {
			diags.AddError(
				"Missing ClusterAuthRolesValue Attribute Value",
				"While creating a ClusterAuthRolesValue value, a missing attribute value was detected. "+
					"A ClusterAuthRolesValue must contain values for all attributes, even if null or unknown. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("ClusterAuthRolesValue Attribute Name (%s) Expected Type: %s", name, attributeType.String()),
			)
		...
		if !attributeType.Equal(attribute.Type(ctx)) {
			diags.AddError(
				"Invalid ClusterAuthRolesValue Attribute Type",
				"While creating a ClusterAuthRolesValue value, an invalid attribute value was detected. "+
					"A ClusterAuthRolesValue must use a matching attribute type for the value. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("ClusterAuthRolesValue Attribute Name (%s) Expected Type: %s\n", name, attributeType.String())+
					fmt.Sprintf("ClusterAuthRolesValue Attribute Name (%s) Given Type: %s", name, attribute.Type(ctx)),
			)
		}
	}
	...
	for name := range attributes {
		...
		if !ok {
			diags.AddError(
				"Extra ClusterAuthRolesValue Attribute Value",
				"While creating a ClusterAuthRolesValue value, an extra attribute value was detected. "+
					"A ClusterAuthRolesValue must not contain values beyond the expected attribute types. "+
					"This is always an issue with the provider and should be reported to the provider developers.\n\n"+
					fmt.Sprintf("Extra ClusterAuthRolesValue Attribute Name: %s", name),
			)
		}
	}

	if diags.HasError() {
		return NewClusterAuthRolesValueUnknown(), diags
	}
...
func NewClusterAuthRolesValueMust(attributeTypes map[string]attr.Type, attributes map[string]attr.Value) ClusterAuthRolesValue {
	object, diags := NewClusterAuthRolesValue(attributeTypes, attributes)
	...
	if diags.HasError() {
		...
		panic("NewClusterAuthRolesValueMust received error(s): " + strings.Join(diagsStrings, "\n"))
	}

	return object
}

func (t ClusterAuthRolesType) ValueFromTerraform(ctx context.Context, in tftypes.Value) (attr.Value, error) {
	if in.Type() == nil {
		return NewClusterAuthRolesValueNull(), nil
	}
	...
	if !in.IsKnown() {
		return NewClusterAuthRolesValueUnknown(), nil
	}
	...
	return NewClusterAuthRolesValueMust(ClusterAuthRolesValue{}.AttributeTypes(ctx), attributes), nil
}

func (t ClusterAuthRolesType) ValueType(ctx context.Context) attr.Value {
	return ClusterAuthRolesValue{}
}

var _ basetypes.ObjectValuable = ClusterAuthRolesValue{}

type ClusterAuthRolesValue struct {
...
func (v ClusterAuthRolesValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
...
func (v ClusterAuthRolesValue) IsNull() bool {
	return v.state == attr.ValueStateNull
}

func (v ClusterAuthRolesValue) IsUnknown() bool {
	return v.state == attr.ValueStateUnknown
}

func (v ClusterAuthRolesValue) String() string {
	return "ClusterAuthRolesValue"
}

func (v ClusterAuthRolesValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (v ClusterAuthRolesValue) Equal(o attr.Value) bool {
	other, ok := o.(ClusterAuthRolesValue)
...
func (v ClusterAuthRolesValue) Type(ctx context.Context) attr.Type {
	return ClusterAuthRolesType{
		basetypes.ObjectType{
...
func (v ClusterAuthRolesValue) AttributeTypes(ctx context.Context) map[string]attr.Type {
