...
package datasource_auth_provider
...
func AuthProviderDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"uuid": schema.StringAttribute{
				...
				MarkdownDescription: "The UUID of the EDA provider whose definition should be retrieved.",
			},
