...
package datasource_namespace_get_response
...
func NamespaceGetResponseDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"namespaces": schema.ListNestedAttribute{
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"name": schema.StringAttribute{
							...
							MarkdownDescription: "The namespace name",
						},
					},
				...
				MarkdownDescription: "The list of namespaces",
			},
		},
	}
}

type NamespaceGetResponseModel struct {
