...
- `targets_affected` (Attributes List) List of nodes affected by this alarm. (see [below for nested schema](#nestedatt--targets_affected))
- `type` (String) A kind for the alarm, e.g. InterfaceDown

<a id="nestedatt--targets_affected"></a>
### Nested Schema for `targets_affected`
